import { show_magicians, magicians } from "./exercise_41";
import { make_great } from "./exercise_42";
// Unchanged Magicians: 
...
// it in a separate array. Call show_magicians() with each array to show that you have one array of 
